...
(global-set-key (kbd "<escape>") 'keyboard-escape-quit) ; <esc> = quit (C-g)
(add-hook 'before-save-hook 'delete-trailing-whitespace) ; Always trim trailing
...
(defun my/org-font-setup ()
  ...
  (dolist (face '((org-level-1 . 2.0)
    ...
    (set-face-attribute 'variable-pitch nil :font "Helvetica" :weight 'regular :height (cdr face)))
